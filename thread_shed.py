#/Users/moonpie/xword/thread_shed.py Sat05Sep2020 {fcG}
...
transactions_clean = []
for trs in daily_transactions_split:
  tran_clean = []
  for datapoint in trs:
      tran_clean.append(datapoint.replace("\n", "").strip(" "))
